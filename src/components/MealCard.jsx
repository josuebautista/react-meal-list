const MealCard = ({ idMeal,image, title, category, country, videoLink, clicked, liked, selectMeal }) => {
  return (
    <div className="col-md-4 col-sm-10 py-2">
      <div className="card rounded-4 bg-light">
      <button type="button" className="border-0 p-0" onClick={() => selectMeal(idMeal)} data-bs-toggle="modal" data-bs-target="#mealModal">
        <img src={image} className="card-img-top rounded-4" alt={title}/>
          ...
          <div className="card-body bg-light">
              <div className="row">
                ...
                <div className="col-3">
                  <button className="border-0 bg-transparent" onClick={clicked}>
                    <img src={liked ? "/images/like-clicked.png" : "/images/like.png"} height={30} width={28} alt='like' ></img>
                  </button>
                </div>
              </div>
          </div>
